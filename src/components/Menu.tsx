...
const categories = [
  ...
  { id: "philippines", name: "Philippines", icon: "" },
  { id: "singapore", name: "Singapore", icon: "" },
  { id: "cambodia", name: "Cambodia", icon: "" },
  { id: "myanmar", name: "Myanmar", icon: "" },
  { id: "laos", name: "Laos", icon: "" },
  { id: "brunei", name: "Brunei", icon: "" },
  { id: "nepal", name: "Nepal", icon: "" },
  { id: "pakistan", name: "Pakistan", icon: "" },
  { id: "sri-lanka", name: "Sri Lanka", icon: "" },
  { id: "bhutan", name: "Bhutan", icon: "" },
  { id: "russia", name: "Russia", icon: "" },
  { id: "uzbekistan", name: "Uzbekistan", icon: "" },
  { id: "saudi-arabia", name: "Saudi Arabia", icon: "" },
  { id: "iran", name: "Iran", icon: "" },
  { id: "lebanon", name: "Lebanon", icon: "" },
  { id: "syria", name: "Syria", icon: "" },
  { id: "yemen", name: "Yemen", icon: "" },
  { id: "jordan", name: "Jordan", icon: "" },
  { id: "mongolia", name: "Mongolia", icon: "" },
  { id: "afghanistan", name: "Afghanistan", icon: "" },
  { id: "turkmenistan", name: "Turkmenistan", icon: "" },
  { id: "tajikistan", name: "Tajikistan", icon: "" },
